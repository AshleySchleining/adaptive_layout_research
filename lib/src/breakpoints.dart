...
class Breakpoints {
  ...
  static const Breakpoint smallWeb =
      WidthPlatformBreakpoint.web(begin: 0, end: 600);
  ...
  static const Breakpoint mediumWeb =
      WidthPlatformBreakpoint.web(begin: 600, end: 840);
  ...
  static const Breakpoint largeWeb = WidthPlatformBreakpoint.web(begin: 840);
}
...
class WidthPlatformBreakpoint extends Breakpoint {
  ...
  const WidthPlatformBreakpoint.web({this.begin, this.end})
      : platform = null,
        platformWeb = true;
  ...
  bool isActive(BuildContext context) {
    ...
    if (platformWeb) {
      isRightPlatform = kIsWeb;
    } else {
      final TargetPlatform host = Theme.of(context).platform;
      isRightPlatform = platform?.contains(host) ?? true;
    }
